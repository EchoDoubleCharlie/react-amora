    ...
    <section id="aboutMe" className={styles.container}>
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          I'm Al-Yashier Amora, an aspiring IT professional passionate 
          about computer hardware servicing. I enjoy maintaining and optimizing computer systems to ensure peak performance.
        </p>
